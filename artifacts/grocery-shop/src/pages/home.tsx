    ...
    >
      <div className="container mx-auto px-4 md:px-6 flex items-center justify-between gap-4 md:gap-8">
        ...
        <nav className="hidden md:flex items-center gap-6 font-medium text-foreground/80">
          ...
          <Link href="#deals" className="hover:text-primary transition-colors">Weekly Deals</Link>
          <Link href="#organic" className="hover:text-primary transition-colors">Organic</Link>
          <Link href="#about" className="hover:text-primary transition-colors">Our Farm</Link>
        </nav>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <Button className="relative rounded-full" size="icon" variant="default">
...
const CATEGORIES = [
  { name: "Fresh Fruits", image: "/images/cat-fruits.png", color: "bg-orange-100" },
  { name: "Vegetables", image: "/images/cat-veg.png", color: "bg-green-100" },
  { name: "Dairy & Eggs", image: "/images/cat-dairy.png", color: "bg-blue-100" },
  { name: "Bakery", image: "/images/cat-bakery.png", color: "bg-amber-100" },
  { name: "Premium Meat", image: "/images/cat-meat.png", color: "bg-red-100" },
];
...
const PRODUCTS = [
  { name: "Hass Avocados", image: "/images/prod-avocado.png", price: 4.99, unit: "per pack of 4", badge: "Organic" },
  { name: "Artisanal Sourdough", image: "/images/prod-bread.png", price: 6.49, unit: "per loaf", badge: "Fresh Baked" },
  { name: "Farm Fresh Eggs", image: "/images/prod-eggs.png", price: 5.99, unit: "per dozen", badge: "Local" },
  { name: "Whole Milk", image: "/images/prod-milk.png", price: 3.49, unit: "per glass bottle", badge: "Grass-fed" },
];
...
function ProductCard({ product }: { product: any }) {
  ...
  return (
    <div className="bg-white rounded-2xl p-4 border border-card-border hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col group">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <Button 
          size="sm" 
          className={`rounded-full h-10 w-10 p-0 transition-colors ${isAdding ? 'bg-secondary text-white' : ''}`}
          onClick={handleAdd}
        >
    ...
    <section id="deals" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex justify-between items-end mb-10">
          ...
          <Button variant="outline" className="hidden md:flex font-semibold rounded-full">
            View All Deals
          </Button>
        </div>
        ...
        <div className="bg-primary rounded-3xl overflow-hidden relative shadow-2xl">
          ...
          <div className="grid md:grid-cols-2 items-center">
            <div className="p-8 md:p-16 relative z-10 text-primary-foreground">
              <span className="inline-block bg-secondary text-secondary-foreground text-sm font-bold px-3 py-1 rounded-full mb-6">
                Limited Time Offer
              </span>
              ...
              <p className="text-primary-foreground/80 text-lg mb-8 max-w-md">
                Experience the difference of truly fresh, locally sourced food. Use code <span className="font-mono bg-black/20 px-2 py-1 rounded font-bold">FRESH20</span> at checkout.
              </p>
              
              <div className="flex gap-4 mb-8">
                <div className="flex flex-col items-center bg-black/20 backdrop-blur rounded-xl p-3 min-w-[70px]">
                  <span className="text-2xl font-bold">02</span>
                  <span className="text-xs uppercase tracking-wider opacity-80">Days</span>
                </div>
                <div className="flex flex-col items-center bg-black/20 backdrop-blur rounded-xl p-3 min-w-[70px]">
                  <span className="text-2xl font-bold">14</span>
                  <span className="text-xs uppercase tracking-wider opacity-80">Hrs</span>
                </div>
                <div className="flex flex-col items-center bg-black/20 backdrop-blur rounded-xl p-3 min-w-[70px]">
            ...
            <div className="hidden md:block h-full relative">
              <img 
                ...
                alt="Fresh fruits" 
                className="absolute inset-0 w-full h-full object-cover object-left mask-image-linear-to-l"
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Subscribe to our weekly newsletter for seasonal recipes, farmer stories, and exclusive subscriber-only deals.
          </p>
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto" onSubmit={(e) => e.preventDefault()}>
            <Input 
              type="email" 
              placeholder="Your email address" 
              className="h-14 rounded-full bg-white border-transparent shadow-sm px-6 text-base"
              required
            />
            <Button size="lg" type="submit" className="h-14 rounded-full px-8">
              Subscribe
            </Button>
          </form>
          <p className="text-xs text-muted-foreground mt-4">
            By subscribing you agree to our Terms & Conditions. No spam, just fresh food.
          </p>
        </div>
      </div>
    </section>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-white/60 mb-6 leading-relaxed">
              Bringing the vibrant, sun-drenched farmers market straight to your kitchen. Taste the difference.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-white/60">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Organic Dairy</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Artisanal Bakery</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Premium Meat</a></li>
              <li><a href="#" className="hover:text-white transition-colors">Weekly Deals</a></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center cursor-pointer hover:bg-white/10 transition-colors">
              <span className="text-white font-serif font-bold">in</span>
            </div>
            <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center cursor-pointer hover:bg-white/10 transition-colors">
              <span className="text-white font-serif font-bold">x</span>
            </div>
          </div>
        </div>
      </div>
